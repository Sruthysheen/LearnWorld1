...
import { registerStudent } from '../../../Utils/api/types';
import { studentRegistration } from '../../../Utils/config/axios.PostMethods'; 
import { useNavigate, Link } from 'react-router-dom';
import { useStudentValidate } from '../../../Utils/Validation/Signupvalidation';
...
const [loading, setLoading] = useState(false);
  ...
  const {errors, handleSubmit, register, reset} = useStudentValidate();
        ...
        >
          ...
          <div className="flex flex-col w-full md:w-2/3 p-4">
            <div className="flex flex-col flex-1 justify-center mb-8">
              <h1 className="text-2xl text-center font-medium text-sky-600">Create your account</h1>
  ...
  <span>Continue with Google</span>
          ...
          <div className="hidden md:w-1/3 rounded-r-lg rounded-l-lg sm:flex justify-center items-center bg-sky-800" >
                <img src="/loginImg.png" className='w-96 h-96 z-20 fixed' alt="" />
          </div>
