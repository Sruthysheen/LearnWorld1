...
import { tutorForgotOtp } from "../../../Utils/config/axios.PostMethods";

function ForgotOtpTutor() {
    ...
    const handleSubmit: any = async (e: any) => {
      try {
        e.preventDefault();
        const res: any = await tutorForgotOtp(otp);
        console.log(res);
        if (res.status) {
          navigate("/tutor/tutornewpassword", { replace: true });
        }
      } catch (error) {}
    };
