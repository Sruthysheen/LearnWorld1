...
var isAdmin = (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, JWT_SECRET, verifiedToken, adminId, admin, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                adminId = verifiedToken.student_id;
                return [4 /*yield*/, adminModel_1.default.findById(adminId).select("-password")];
            case 2:
                admin = _b.sent();
                if (admin) {
